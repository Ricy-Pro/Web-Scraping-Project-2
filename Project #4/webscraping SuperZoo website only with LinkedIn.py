...
try:
    ...
    def get_info(url1):
     try:
        ...
        linkedin1 = soup1.find("a", {"id": "ctl00_ContentPlaceHolder1_ctrlCustomField_Logos_dlCustomFieldList_ctl01_lnkCustomField"})['href']
    ...
    for product in product_elements[3:-1]:
        v = product.find("td", {"class": "cf CustomField_20"})
        if v is not None:
    ...
    with open(csv_filename, "w", newline="", encoding="utf-8") as csvfile:
        fieldnames = ["Name", "LinkedIn", "Country", "City","State","Website_link","Brands","Description"]
